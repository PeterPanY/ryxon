...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="代码规范" tabindex="-1">代码规范 <a class="header-anchor" href="#代码规范" aria-hidden="true">#</a></h2><p>在编写代码时，请注意：</p><ul><li>确保代码可以通过仓库的 ESLint 校验。</li><li>确保代码格式是规范的，使用 prettier 进行代码格式化。</li><li>确保没有使用超出兼容性范围的 API，比如 <code>async/await</code>。</li></ul><h2 id="issue-规范" tabindex="-1">Issue 规范 <a class="header-anchor" href="#issue-规范" aria-hidden="true">#</a></h2><ul><li>遇到问题时，请先确认这个问题是否已经在 issue 中有记录或者已被修复。</li><li>提 issue 时，请用简短的语言描述遇到的问题，并添加出现问题时的环境和复现步骤。</li></ul>`,23),o=[p];function t(c,i,r,d,C,y){return a(),n("div",null,o)}const u=s(e,[["render",t]]);export{A as __pageData,u as default};
