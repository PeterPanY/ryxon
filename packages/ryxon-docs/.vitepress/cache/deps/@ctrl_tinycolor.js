...
function isReadable(color1, color2, wcag2) {
  ...
  switch (
    ((_a = wcag2.level) !== null && _a !== void 0 ? _a : 'AA') +
    ((_b = wcag2.size) !== null && _b !== void 0 ? _b : 'small')
  ) {
    case 'AAsmall':
    case 'AAAlarge':
...
function mostReadable(baseColor, colorList, args) {
  ...
  if (
    isReadable(baseColor, bestColor, { level, size }) ||
...
function toMsFilter(firstColor, secondColor) {
  ...
  return 'progid:DXImageTransform.Microsoft.gradient('
    .concat(gradientType, 'startColorstr=')
    .concat(hex8String, ',endColorstr=')
