import {
  ...
  tryOnScopeDispose,
  unrefElement
} from './chunk-5MQ5XLSI.js'
import './chunk-M26XLJDO.js'
...
// ../../node_modules/.pnpm/@vueuse+integrations@10.7.2_focus-trap@7.5.4_sortablejs@1.15.1_vue@3.4.27_typescript@5.4.5_/node_modules/@vueuse/integrations/useSortable.mjs
function useSortable(el, list, options = {}) {
  ...
  const start = () => {
    const target =
      typeof el === 'string'
        ? document2 == null
          ? void 0
          : document2.querySelector(el)
        : unrefElement(el)
    if (!target || sortable !== void 0) return
    sortable = new sortable_esm_default(target, {
      ...defaultOptions,
      ...resetOptions
    })
  }
  ...
  const option2 = (name, value) => {
    ...
    else return sortable == null ? void 0 : sortable.option(name)
  }
  tryOnMounted(start)
