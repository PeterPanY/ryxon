...
var __spreadValues$9 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$b.call(b, prop)) __defNormalProp$9(a, prop, b[prop])
...
function computedEager(fn, options) {
  ...
  watchEffect(
    ...
    __spreadProps$6(__spreadValues$9({}, options), {
      flush:
        (_a2 = options == null ? void 0 : options.flush) != null ? _a2 : 'sync'
    })
  )
...
function increaseWithUnit(target, delta) {
  ...
  const value =
    ((_a2 = target.match(/^-?[0-9]+\.?[0-9]*/)) == null ? void 0 : _a2[0]) || ''
...
var __spreadValues$8 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$a.call(b, prop)) __defNormalProp$8(a, prop, b[prop])
...
function refWithControl(initial, options = {}) {
  ...
  function set3(value, triggering = true) {
    ...
    const old = source
    if (
      ((_a2 = options.onBeforeChange) == null
        ? void 0
        : _a2.call(options, value, old)) === false
    )
      return
    source = value
...
var __spreadValues$7 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$9.call(b, prop)) __defNormalProp$7(a, prop, b[prop])
    ...
    result[key] = customRef(() => ({
      ...
      set(v) {
        if (Array.isArray(objectRef.value)) {
          ...
          const newObject = __spreadProps$5(
            __spreadValues$7({}, objectRef.value),
            { [key]: v }
          )
...
function useArrayEvery(list, fn) {
  return computed(() =>
    resolveUnref(list).every((element, index, array) =>
      fn(resolveUnref(element), index, array)
    )
  )
}
...
function useArrayFind(list, fn) {
  return computed(() =>
    resolveUnref(
      resolveUnref(list).find((element, index, array) =>
        fn(resolveUnref(element), index, array)
      )
    )
  )
...
function useArrayFindIndex(list, fn) {
  return computed(() =>
    resolveUnref(list).findIndex((element, index, array) =>
      fn(resolveUnref(element), index, array)
    )
  )
}
...
function useArrayReduce(list, reducer, ...args) {
  const reduceCallback = (sum, value, index) =>
    reducer(resolveUnref(sum), resolveUnref(value), index)
  return computed(() => {
...
function useArraySome(list, fn) {
  return computed(() =>
    resolveUnref(list).some((element, index, array) =>
      fn(resolveUnref(element), index, array)
    )
  )
}
function useArrayUnique(list) {
  return computed(() => [
    ...new Set(resolveUnref(list).map((element) => resolveUnref(element)))
  ])
}
...
var formatDate = (date, formatStr, options = {}) => {
  ...
  const meridiem =
    (_a2 = options.customMeridiem) != null ? _a2 : defaultMeridiem
  const matches = {
...
function useDateFormat(date, formatStr = 'HH:mm:ss', options = {}) {
  return computed(() =>
    formatDate(
      normalizeDate(resolveUnref(date)),
...
var __spreadValues$6 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$8.call(b, prop)) __defNormalProp$6(a, prop, b[prop])
...
var __spreadValues$5 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$7.call(b, prop)) __defNormalProp$5(a, prop, b[prop])
...
function watchDebounced(source, cb, options = {}) {
  const _a2 = options,
    { debounce = 0, maxWait = void 0 } = _a2,
    watchOptions = __objRest$3(_a2, ['debounce', 'maxWait'])
  return watchWithFilter(
    source,
    cb,
    __spreadProps$4(__spreadValues$4({}, watchOptions), {
...
function watchIgnorable(source, cb, options = {}) {
  const _a2 = options,
    { eventFilter = bypassFilter } = _a2,
    watchOptions = __objRest$2(_a2, ['eventFilter'])
...
function watchThrottled(source, cb, options = {}) {
  const _a2 = options,
    { throttle = 0, trailing = true, leading = true } = _a2,
    watchOptions = __objRest(_a2, ['throttle', 'trailing', 'leading'])
  return watchWithFilter(
    source,
    cb,
...
function onKeyDown(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$9(__spreadValues$m({}, options), { eventName: 'keydown' })
  )
}
function onKeyPressed(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$9(__spreadValues$m({}, options), { eventName: 'keypress' })
  )
}
function onKeyUp(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$9(__spreadValues$m({}, options), { eventName: 'keyup' })
  )
}
...
function onLongPress(target, handler, options) {
  ...
  function onDown(ev) {
    var _a22, _b2, _c, _d
    if (
      ((_a22 = options == null ? void 0 : options.modifiers) == null
        ? void 0
        : _a22.self) &&
...
var __spreadValues$l = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$n.call(b, prop)) __defNormalProp$l(a, prop, b[prop])
...
var __spreadValues$k = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$m.call(b, prop)) __defNormalProp$k(a, prop, b[prop])
...
function useCloned(source, options = {}) {
  ...
  if (!manual && isRef(source)) {
    watch(
      source,
      sync,
      __spreadProps$8(__spreadValues$k({}, options), {
        deep,
        immediate
      })
    )
...
var __spreadValues$j = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$l.call(b, prop)) __defNormalProp$j(a, prop, b[prop])
...
function useStorage(key, defaults2, storage, options = {}) {
  ...
  const serializer =
    (_a2 = options.serializer) != null ? _a2 : StorageSerializers[type]
...
var __spreadValues$i = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$k.call(b, prop)) __defNormalProp$i(a, prop, b[prop])
...
function useCssVar(
  prop,
  target,
  { window: window2 = defaultWindow, initialValue = '' } = {}
) {
  ...
  watch(
    ...
    ([el, prop2]) => {
      ...
      if (el && window2) {
        const value =
          (_a2 = window2.getComputedStyle(el).getPropertyValue(prop2)) == null
            ? void 0
            : _a2.trim()
...
function useCycleList(list, options) {
  ...
  const state = shallowRef(
    (_a2 = options == null ? void 0 : options.initialValue) != null
      ? _a2
      : list[0]
  )
  const index = computed({
    get() {
      ...
      if (index2 < 0)
        index2 =
          (_a22 = options == null ? void 0 : options.fallbackIndex) != null
            ? _a22
            : 0
      return index2
    },
...
function useDark(options = {}) {
  ...
  const mode = useColorMode(
    __spreadProps$7(__spreadValues$h({}, options), {
      onChanged: (mode2, defaultHandler) => {
        var _a2
        if (options.onChanged)
          (_a2 = options.onChanged) == null
            ? void 0
            : _a2.call(options, mode2 === 'dark')
...
function useRefHistory(source, options = {}) {
  ...
  const manualHistory = useManualRefHistory(
    source,
    __spreadProps$62(__spreadValues$g({}, options), {
...
function useDebouncedRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(
    source,
    __spreadProps$52(__spreadValues$f({}, options), { eventFilter: filter })
  )
...
function useDisplayMedia(options = {}) {
  ...
  const isSupported = useSupported(() => {
    var _a22
    return (_a22 = navigator == null ? void 0 : navigator.mediaDevices) == null
      ? void 0
  ...
  async function _stop() {
    ...
    ;(_a22 = stream.value) == null
      ? void 0
      : _a22.getTracks().forEach((t) => t.stop())
    stream.value = void 0
  }
  function stop() {
    _stop()
...
function useDraggable(target, options = {}) {
  ...
  const draggingElement =
    (_a2 = options.draggingElement) != null ? _a2 : defaultWindow
  const draggingHandle = (_b = options.handle) != null ? _b : target
  const position = ref(
    (_c = resolveUnref(options.initialValue)) != null ? _c : { x: 0, y: 0 }
  )
  ...
  const start = (e) => {
    ...
    if (
      ((_a22 = options.onStart) == null
        ? void 0
        : _a22.call(options, pos, e)) === false
    )
      return
  ...
  const move = (e) => {
    ...
    ;(_a22 = options.onMove) == null
      ? void 0
      : _a22.call(options, position.value, e)
    handleEvent(e)
  }
  const end = (e) => {
    var _a22
  ...
  if (isClient) {
    ...
    useEventListener(target, 'drop', (event) => {
      ...
      const files = Array.from(
        (_b = (_a2 = event.dataTransfer) == null ? void 0 : _a2.files) != null
          ? _b
          : []
      )
...
function useResizeObserver(target, callback, options = {}) {
  const _a2 = options,
    ...
    observerOptions = __objRest$22(_a2, ['window'])
  let observer
...
var __spreadValues$d = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$e.call(b, prop)) __defNormalProp$d(a, prop, b[prop])
...
function useEventBus(key) {
  ...
  function emit(event, payload) {
    var _a2
    ;(_a2 = events.get(key)) == null
      ? void 0
      : _a2.forEach((v) => v(event, payload))
  }
...
var __spreadValues$c = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$d.call(b, prop)) __defNormalProp$c(a, prop, b[prop])
      ...
      await callbacks.reduce(
        (prevCallback, callback) =>
          prevCallback.then(async () => {
            if (callback)
              ctx = __spreadValues$c(
                __spreadValues$c({}, ctx),
                await callback(ctx)
              )
          }),
        Promise.resolve()
  ...
  function useFactoryFetch(url, ...args) {
    ...
    if (args.length > 0) {
      if (isFetchOptions(args[0])) {
        options = __spreadProps$32(
          __spreadValues$c(__spreadValues$c({}, options), args[0]),
          {
        ...
        fetchOptions = __spreadProps$32(
          __spreadValues$c(__spreadValues$c({}, fetchOptions), args[0]),
          {
            headers: __spreadValues$c(
              __spreadValues$c({}, headersToObject(fetchOptions.headers) || {}),
    ...
    if (args.length > 1 && isFetchOptions(args[1])) {
      options = __spreadProps$32(
        __spreadValues$c(__spreadValues$c({}, options), args[1]),
        {
          beforeFetch: combineCallbacks(
            _combination,
            _options.beforeFetch,
...
function useFetch(url, ...args) {
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    if (config.payload) {
      ...
      if (config.payloadType)
        headers['Content-Type'] =
          (_a22 = payloadMapping[config.payloadType]) != null
            ? _a22
            : config.payloadType
    ...
    const context = {
      ...
      options: __spreadValues$c(
        __spreadValues$c({}, defaultFetchOptions),
        fetchOptions
      ),
      cancel: () => {
        isCanceled = true
        ...
        __spreadProps$32(
          ...
          ),
          {
            headers: __spreadValues$c(
              ...
              headersToObject(
                (_a3 = context.options) == null ? void 0 : _a3.headers
              )
            )
          }
        )
    ...
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        if (isRef(config.payload)) {
          watch(
            [refetch, resolveRef(config.payload)],
...
var __spreadValues$b = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$c.call(b, prop)) __defNormalProp$b(a, prop, b[prop])
...
function useFileDialog(options = {}) {
  ...
  const open = (localOptions) => {
    if (!input) return
    const _options = __spreadValues$b(
      __spreadValues$b(__spreadValues$b({}, DEFAULT_OPTIONS), options),
      localOptions
    )
...
var __spreadValues$a = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$b2.call(b, prop)) __defNormalProp$a(a, prop, b[prop])
  if (__getOwnPropSymbols$b2)
    for (var prop of __getOwnPropSymbols$b2(b)) {
      if (__propIsEnum$b2.call(b, prop)) __defNormalProp$a(a, prop, b[prop])
    }
  return a
}
function useFileSystemAccess(options = {}) {
  const { window: _window = defaultWindow, dataType = 'Text' } = unref(options)
  ...
  const fileName = computed(() => {
    var _a2, _b
    return (_b = (_a2 = file.value) == null ? void 0 : _a2.name) != null
      ? _b
      : ''
  })
  const fileMIME = computed(() => {
    var _a2, _b
    return (_b = (_a2 = file.value) == null ? void 0 : _a2.type) != null
      ? _b
      : ''
  })
  const fileSize = computed(() => {
    var _a2, _b
    return (_b = (_a2 = file.value) == null ? void 0 : _a2.size) != null
      ? _b
      : 0
  })
  const fileLastModified = computed(() => {
    var _a2, _b
    return (_b = (_a2 = file.value) == null ? void 0 : _a2.lastModified) != null
      ? _b
      : 0
  })
  async function open(_options = {}) {
    ...
    const [handle] = await window2.showOpenFilePicker(
      __spreadValues$a(__spreadValues$a({}, unref(options)), _options)
    )
  ...
  async function updateFile() {
    var _a2
    file.value = await ((_a2 = fileHandle.value) == null
      ? void 0
      : _a2.getFile())
  }
...
function useFocus(target, options = {}) {
  ...
  const focused = computed({
    get() {
      return (
        isDef(activeElement.value) &&
        isDef(targetElement.value) &&
...
function useFps(options) {
  ...
  const every =
    (_a2 = options == null ? void 0 : options.every) != null ? _a2 : 10
    ...
    for (let i = 0; i < _gamepads.length; ++i) {
      ...
      if (gamepad) {
        const index = gamepads.value.findIndex(
          ({ index: index2 }) => index2 === gamepad.index
        )
...
var __defNormalProp$92 = (obj, key, value) =>
  key in obj
    ? __defProp$92(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$92 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$a2.call(b, prop)) __defNormalProp$92(a, prop, b[prop])
  if (__getOwnPropSymbols$a2)
    for (var prop of __getOwnPropSymbols$a2(b)) {
      if (__propIsEnum$a2.call(b, prop)) __defNormalProp$92(a, prop, b[prop])
    }
  return a
}
...
function useScroll(element, options = {}) {
  ...
  function scrollTo(_x, _y) {
    ...
    if (!_element) return
    ;(_c = _element instanceof Document ? document.body : _element) == null
      ? void 0
      : _c.scrollTo({
...
var __defNormalProp$82 = (obj, key, value) =>
  key in obj
    ? __defProp$82(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$82 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$92.call(b, prop)) __defNormalProp$82(a, prop, b[prop])
  if (__getOwnPropSymbols$92)
    for (var prop of __getOwnPropSymbols$92(b)) {
      if (__propIsEnum$92.call(b, prop)) __defNormalProp$82(a, prop, b[prop])
    }
  return a
}
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const state = reactive(
    useScroll(
      element,
      __spreadProps$22(__spreadValues$82({}, options), {
        ...
        const previous = {
          height:
            (_a22 = elem == null ? void 0 : elem.scrollHeight) != null
              ...
              : 0,
          width:
            (_b2 = elem == null ? void 0 : elem.scrollWidth) != null ? _b2 : 0
        }
...
var __defNormalProp$72 = (obj, key, value) =>
  key in obj
    ? __defProp$72(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$72 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$82.call(b, prop)) __defNormalProp$72(a, prop, b[prop])
  if (__getOwnPropSymbols$82)
    for (var prop of __getOwnPropSymbols$82(b)) {
      if (__propIsEnum$82.call(b, prop)) __defNormalProp$72(a, prop, b[prop])
    }
  return a
}
...
function useMediaControls(target, options = {}) {
  ...
  useEventListener(target, 'timeupdate', () =>
    ignoreCurrentTimeUpdates(
      () => (currentTime.value = resolveUnref(target).currentTime)
    )
  )
  useEventListener(
    target,
    'durationchange',
    () => (duration.value = resolveUnref(target).duration)
  )
  useEventListener(
    target,
    'progress',
    () => (buffered.value = timeRangeToArray(resolveUnref(target).buffered))
  )
  ...
  useEventListener(
    target,
    'ratechange',
    () => (rate.value = resolveUnref(target).playbackRate)
  )
...
function useMutationObserver(target, callback, options = {}) {
  const _a2 = options,
    { window: window2 = defaultWindow } = _a2,
    mutationOptions = __objRest$12(_a2, ['window'])
  let observer
  const isSupported = useSupported(
...
var __defNormalProp$62 = (obj, key, value) =>
  key in obj
    ? __defProp$62(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$62 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$62.call(b, prop)) __defNormalProp$62(a, prop, b[prop])
  if (__getOwnPropSymbols$62)
    for (var prop of __getOwnPropSymbols$62(b)) {
      if (__propIsEnum$62.call(b, prop)) __defNormalProp$62(a, prop, b[prop])
    }
  return a
}
...
function useOffsetPagination(options) {
  ...
  const pageCount = computed(() =>
    Math.max(1, Math.ceil(unref(total) / unref(currentPageSize)))
  )
...
var __defNormalProp$52 = (obj, key, value) =>
  key in obj
    ? __defProp$52(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$52 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$52.call(b, prop)) __defNormalProp$52(a, prop, b[prop])
  if (__getOwnPropSymbols$52)
    for (var prop of __getOwnPropSymbols$52(b)) {
      if (__propIsEnum$52.call(b, prop)) __defNormalProp$52(a, prop, b[prop])
    }
  return a
}
...
function usePointerSwipe(target, options = {}) {
  ...
  const eventIsAllowed = (e) => {
    ...
    return (_c =
      (_b =
        (_a2 = options.pointerTypes) == null
          ? void 0
          : _a2.includes(e.pointerType)) != null
        ? _b
  ...
  const stops = [
    useEventListener(target, 'pointerdown', (e) => {
      ...
      ;(_b = (_a2 = targetRef.value) == null ? void 0 : _a2.style) == null
        ? void 0
...
var __defNormalProp$42 = (obj, key, value) =>
  key in obj
    ? __defProp$42(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$42 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$42.call(b, prop)) __defNormalProp$42(a, prop, b[prop])
  if (__getOwnPropSymbols$42)
    for (var prop of __getOwnPropSymbols$42(b)) {
      if (__propIsEnum$42.call(b, prop)) __defNormalProp$42(a, prop, b[prop])
    }
  return a
}
function useShare(shareOptions = {}, options = {}) {
  ...
  const share = async (overrideOptions = {}) => {
    if (isSupported.value) {
      const data = __spreadValues$42(
        __spreadValues$42({}, resolveUnref(shareOptions)),
...
function useTextDirection(options = {}) {
  ...
  function getValue2() {
    var _a2, _b
    return (_b =
      (_a2 = document2 == null ? void 0 : document2.querySelector(selector)) ==
      null
        ? void 0
  ...
  return computed({
    ...
    set(v) {
      ...
      if (!document2) return
      if (dir.value)
        (_a2 = document2.querySelector(selector)) == null
          ? void 0
          : _a2.setAttribute('dir', dir.value)
      else
...
function useTextSelection(options = {}) {
  ...
  const text = computed(() => {
    var _a2, _b
    return (_b = (_a2 = selection.value) == null ? void 0 : _a2.toString()) !=
      null
      ? _b
      : ''
  })
...
var __defNormalProp$32 = (obj, key, value) =>
  key in obj
    ? __defProp$32(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$32 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$32.call(b, prop)) __defNormalProp$32(a, prop, b[prop])
  if (__getOwnPropSymbols$32)
    for (var prop of __getOwnPropSymbols$32(b)) {
      if (__propIsEnum$32.call(b, prop)) __defNormalProp$32(a, prop, b[prop])
    }
  return a
}
...
function useThrottledRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(
    source,
    __spreadProps2(__spreadValues$32({}, options), { eventFilter: filter })
  )
...
var __defNormalProp$22 = (obj, key, value) =>
  key in obj
    ? __defProp$22(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$22 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$22.call(b, prop)) __defNormalProp$22(a, prop, b[prop])
  if (__getOwnPropSymbols$22)
    for (var prop of __getOwnPropSymbols$22(b)) {
      if (__propIsEnum$22.call(b, prop)) __defNormalProp$22(a, prop, b[prop])
    }
  return a
}
...
function useTimeAgo(time, options = {}) {
  ...
  const _a2 = useNow({ interval: updateInterval, controls: true }),
    { now: now2 } = _a2,
    controls = __objRest2(_a2, ['now'])
  const timeAgo = computed(() =>
    formatTimeAgo(new Date(resolveUnref(time)), options, unref(now2.value))
  )
  if (exposeControls) {
...
function formatTimeAgo(from, options = {}, now2 = Date.now()) {
  ...
  if (typeof max === 'string') {
    const unitMax =
      (_a2 = units.find((i) => i.name === max)) == null ? void 0 : _a2.max
...
var __defNormalProp$12 = (obj, key, value) =>
  key in obj
    ? __defProp$12(obj, key, {
        enumerable: true,
        configurable: true,
        writable: true,
        value
...
var __spreadValues$12 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$12.call(b, prop)) __defNormalProp$12(a, prop, b[prop])
  if (__getOwnPropSymbols$12)
    for (var prop of __getOwnPropSymbols$12(b)) {
      if (__propIsEnum$12.call(b, prop)) __defNormalProp$12(a, prop, b[prop])
    }
  return a
}
...
function useTitle(newTitle = null, options = {}) {
  ...
  watch(
    title,
    (t, o) => {
      if (t !== o && document2) document2.title = format(isString(t) ? t : '')
    },
    { immediate: true }
  )
...
function useTransition(source, options = {}) {
  ...
  const start = () => {
    ...
    diffVector = outputVector.value.map((n, i) => {
      var _a2, _b
      return (
        ((_a2 = sourceVector.value[i]) != null ? _a2 : 0) -
        ((_b = outputVector.value[i]) != null ? _b : 0)
      )
    })
...
function useVModel(props, key, emit, options = {}) {
  ...
  const cloneFn = (val) =>
    !clone ? val : isFunction(clone) ? clone(val) : cloneFnJSON(val)
  const getValue2 = () =>
...
function useWebWorker(arg0, workerOptions, options) {
  ...
  if (window2) {
    if (isString(arg0)) worker.value = new Worker(arg0, workerOptions)
    else if (isFunction(arg0)) worker.value = arg0()
