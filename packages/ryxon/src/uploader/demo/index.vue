...
<template>
  ...
  <demo-block :title="t('preview')">
    <r-uploader v-model="fileList" multiple accept="*" />
  </demo-block>

  <demo-block :title="t('status')">
    <r-uploader v-model="statusFileList" :after-read="afterReadFailed" />
  </demo-block>

  <demo-block :title="t('maxCount')">
    <r-uploader v-model="fileList2" multiple :max-count="2" />
  </demo-block>
  ...
  <demo-block :title="t('customUpload')">
    <r-uploader>
      <r-button type="primary" icon="plus">
        {{ t('upload') }}
      </r-button>
    </r-uploader>
  </demo-block>
  ...
  <demo-block :title="t('previewCover')">
    <r-uploader v-model="previewCoverFiles">
  ...
  <demo-block :title="t('previewSize')">
    <r-uploader v-model="previewSizeFiles" preview-size="60" />
  </demo-block>

  <demo-block :title="t('beforeRead')">
    <r-uploader v-model="fileList3" :before-read="beforeRead" />
  </demo-block>

  <demo-block :title="t('disabled')">
    <r-uploader :after-read="afterRead" disabled />
  </demo-block>

  <demo-block :title="t('customPreviewImage')">
    <r-uploader v-model="fileList5" multiple accept="*" :deletable="false" />
  </demo-block>
</template>
