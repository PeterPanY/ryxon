...
<template>
  ...
  <demo-block :title="t('customSize')">
    <r-switch v-model="checked2" size="22px" />
  </demo-block>
  ...
  <demo-block :title="t('customNode')">
    <r-switch v-model="checked3">
      <template #node>
        <div class="icon-wrapper">
          <r-icon :name="checked3 ? 'success' : 'cross'" />
        </div>
      </template>
    </r-switch>
  </demo-block>
  ...
  <demo-block :title="t('asyncControl')">
    <r-switch :model-value="checked4" @update:model-value="onUpdateValue" />
  </demo-block>

  <demo-block :title="t('withCell')">
    <r-cell center :title="t('title')">
      <template #right-icon>
        <r-switch v-model="checked5" />
      </template>
    </r-cell>
  </demo-block>
</template>
