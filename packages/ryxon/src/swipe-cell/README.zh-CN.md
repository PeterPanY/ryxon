...
<r-swipe-cell>
  <template #left>
    <r-button square type="primary" text="选择" />
  </template>
  <r-cell :border="false" title="单元格" value="内容" />
  <template #right>
    <r-button square type="danger" text="删除" />
    <r-button square type="primary" text="收藏" />
  </template>
</r-swipe-cell>
```
...
<r-swipe-cell>
  ...
  />
  <template #right>
    <r-button square text="删除" type="danger" class="delete-button" />
  </template>
</r-swipe-cell>
