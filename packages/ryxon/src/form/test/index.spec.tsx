...
test('should render correctly when dynamically add/remove inputs', async () => {
    ...
    render() {
      return (
        <Form onSubmit={onSubmit}>
          {this.list.map((item) => (
            <Input key={item} name={item} modelValue="" />
          ))}
        </Form>
      )
    },
...
test('should validate first correctly when dynamically add input', async () => {
