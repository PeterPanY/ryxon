...
<template>
  <demo-block :title="t('fieldType')">
    <r-form @submit="onSubmit">
      <r-cell-group inset>
        <r-field name="switch" :label="t('switch')">
          <template #input>
            <r-switch v-model="switchChecked" />
          </template>
        </r-field>

        <r-field name="checkbox" :label="t('checkbox')">
          <template #input>
            <r-checkbox v-model="checkbox" shape="square" />
          </template>
        </r-field>

        <r-field name="checkboxGroup" :label="t('checkboxGroup')">
          <template #input>
        ...
        <r-field name="radio" :label="t('radio')">
          <template #input>
        ...
        <r-field name="stepper" :label="t('stepper')">
          <template #input>
        ...
        <r-field name="uploader" :label="t('uploader')">
          <template #input>
