...
```html
<r-checkbox v-model="checked" disabled>复选框</r-checkbox>
```
...
```html
<r-checkbox v-model="checked" shape="square">复选框</r-checkbox>
```
...
```html
<r-checkbox v-model="checked" checked-color="#ee0a24">复选框</r-checkbox>
```
...
```html
<r-checkbox v-model="checked" icon-size="24px">复选框</r-checkbox>
```
...
<r-button type="primary" @click="checkAll">全选</r-button>
<r-button type="primary" @click="toggleAll">反选</r-button>
```
