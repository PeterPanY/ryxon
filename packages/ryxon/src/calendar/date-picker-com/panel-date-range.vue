<template>
  ...
  >
    <div :class="ppNs('body-wrapper')">
      ...
      <div :class="ppNs('body')">
        <div v-if="showTime" :class="drpNs('time-header')">
          <span :class="drpNs('editors-wrap')">
            <span :class="drpNs('time-picker-wrap')">
              <r-input
                size="small"
                :disabled="rangeState.selecting"
                :placeholder="t('rDatepicker.startDate')"
                :class="drpNs('editor')"
          ...
          <span
            ...
            :class="drpNs('time-picker-wrap')"
          >
            <r-input
              size="small"
              :class="drpNs('editor')"
              :disabled="rangeState.selecting"
              :placeholder="t('rDatepicker.startTime')"
          ...
          <span :class="drpNs('editors-wrap')" class="is-right">
            <span :class="drpNs('time-picker-wrap')">
              <r-input
                size="small"
                :class="drpNs('editor')"
                :disabled="rangeState.selecting"
                :placeholder="t('rDatepicker.endDate')"
            ...
            >
              <r-input
                ...
                :class="drpNs('editor')"
                :disabled="rangeState.selecting"
                :placeholder="t('rDatepicker.endTime')"
    ...
    <div v-if="showTime" :class="ppNs('footer')">
      <r-button
        v-if="clearable"
        text
        size="small"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const leftLabel = computed(
      () =>
        `${leftDate.value.year()} ${t('rDatepicker.year')} ${t(
          `rDatepicker.month${leftDate.value.month() + 1}`
        )}`
    )

    const rightLabel = computed(
      () =>
        `${rightDate.value.year()} ${t('rDatepicker.year')} ${t(
          `rDatepicker.month${rightDate.value.month() + 1}`
        )}`
    )
