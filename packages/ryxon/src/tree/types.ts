...
export declare type TreeAllowDropType = 'inner' | 'prev' | 'next'
...
export declare type TreeFilterValue = any
...
export declare type TreeNodeDropType = 'before' | 'after' | 'inner' | 'none'

export type TreeThemeVars = {
  treeNodeHoverBgColor?: string
  treeTextColor?: string
  treeExpandIconColor?: string
}
