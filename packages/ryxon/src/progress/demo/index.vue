...
<template>
  ...
  <demo-block :title="t('title3')">
    <r-progress color="#f2826a" :percentage="25" :pivot-text="t('orange')" />
    <r-progress color="#ee0a24" :percentage="50" :pivot-text="t('red')" />
    <r-progress
      :percentage="75"
      :pivot-text="t('purple')"
      pivot-color="#7232dd"
  ...
  <demo-block :title="t('transition')">
    ...
    <div style="margin-top: 15px">
      <r-button :text="t('add')" type="primary" size="small" @click="add" />
      <r-button
        :text="t('decrease')"
        type="danger"
        size="small"
...
.demo-progress {
  ...
  .r-button {
    margin: var(--r-padding-md) 0 0 10px;
