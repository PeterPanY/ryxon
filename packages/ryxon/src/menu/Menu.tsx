...
export default defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    const [, nsSubMenu] = createNamespace('sub-menu')
    ...
    onMounted(() => {
      if (props.mode === 'horizontal') {
        new Menubar(instance.vnode.el!, 'r')
      }
    })
    ...
    return () => {
      ...
      const vMenu = h(
        'ul',
        {
          ...
          class: {
            [nsMenu()]: true,
            [nsMenu(props.mode)]: true,
            [nsMenu('collapse')]: props.collapse
          }
        },
        [...slot, ...vShowMore]
      )
