...
<template>
  <demo-block card :title="t('basicUsage')">
    <r-cell is-link :title="t('title1')" @click="showToast(t('text'))" />
    <r-cell
      is-link
      :title="t('title2')"
    ...
    />
    <r-cell is-link :title="t('fail')" @click="showFailToast(t('text3'))" />
  </demo-block>

  <demo-block card :title="t('customIcon')">
    <r-cell is-link :title="t('customIcon')" @click="showIconToast" />
    <r-cell is-link :title="t('customImage')" @click="showImageToast" />
    <r-cell
      is-link
      :title="t('loadingType')"
  ...
  <demo-block card :title="t('customPosition')">
    <r-cell is-link :title="t('positionTop')" @click="showTopToast" />
    <r-cell is-link :title="t('positionBottom')" @click="showBottomToast" />
  </demo-block>
  ...
  <demo-block card :title="t('updateMessage')">
    <r-cell is-link :title="t('updateMessage')" @click="showCustomToast" />
  </demo-block>
