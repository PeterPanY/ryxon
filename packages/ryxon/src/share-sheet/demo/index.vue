...
<template>
  <demo-block card :title="t('basicUsage')">
    <r-cell is-link :title="t('showSheet')" @click="showBasic = true" />
    <r-share-sheet
  ...
  <demo-block card :title="t('multiLine')">
    <r-cell is-link :title="t('showSheet')" @click="showMultiLine = true" />
    <r-share-sheet
  ...
  <demo-block card :title="t('customIcon')">
    <r-cell is-link :title="t('showSheet')" @click="showCustomIcon = true" />
    <r-share-sheet
  ...
  <demo-block card :title="t('withDesc')">
    <r-cell is-link :title="t('showSheet')" @click="showWithDesc = true" />
    <r-share-sheet
