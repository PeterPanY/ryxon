...
<template>
  <demo-block card :title="t('basicUsage')">
    <r-cell is-link :title="t('basicUsage')" @click="showBasic = true" />
    <r-cell is-link :title="t('showCancel')" @click="showCancel = true" />
    <r-cell
      is-link
  ...
  <demo-block card :title="t('optionStatus')">
    <r-cell is-link :title="t('optionStatus')" @click="showStatus = true" />
  </demo-block>

  <demo-block card :title="t('customPanel')">
    <r-cell is-link :title="t('customPanel')" @click="showTitle = true" />
  </demo-block>
  ...
  <r-action-sheet v-model:show="showTitle" :title="t('title')">
...
.demo-action-sheet {
  &-content {
    padding: var(--r-padding-md) var(--r-padding-md)
      calc(var(--r-padding-md) * 10);
  }
}
</style>
