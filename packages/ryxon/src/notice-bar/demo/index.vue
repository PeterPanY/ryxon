...
<template>
  <demo-block :title="t('basicUsage')">
    <r-notice-bar :text="t('text1')" scrollable left-icon="volume-o" />
  </demo-block>

  <demo-block :title="t('scrollable')">
    <r-notice-bar scrollable :text="t('haiku')" />
    <r-notice-bar :scrollable="false" :text="t('text2')" />
  </demo-block>

  <demo-block :title="t('wrapable')">
    <r-notice-bar wrapable :scrollable="false" :text="t('text2')" />
  </demo-block>

  <demo-block :title="t('mode')">
    <r-notice-bar mode="closeable" :text="t('haiku')" />
    <r-notice-bar mode="link" :text="t('haiku')" />
  </demo-block>
  ...
  <demo-block :title="t('verticalScroll')">
    <r-notice-bar left-icon="volume-o" :scrollable="false">
      ...
      >
        ...
        <r-swipe-item>{{ t('poetry3') }}</r-swipe-item>
      </r-swipe>
    </r-notice-bar>
  </demo-block>
</template>
...
<style lang="less">
.demo-notice-bar {
  .r-notice-bar:not(:first-of-type) {
    margin-top: 4px;
  }
