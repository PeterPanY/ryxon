<template>
  <div
    :class="['r-doc-content', `r-doc-content--${currentPage}`]"
    @click="onClick"
  >
    <slot />
  </div>
...
.r-doc-card {
  ...
  > table {
    ...
    td {
      padding: 8px;
      border-top: 1px solid var(--r-doc-border-color);
  ...
  > blockquote {
    ...
    font-size: 15px;
    line-height: 26px;
    color: var(--r-doc-blockquote-color);
    background-color: var(--r-doc-blockquote-background);
    border-radius: var(--r-doc-border-radius);
  }
