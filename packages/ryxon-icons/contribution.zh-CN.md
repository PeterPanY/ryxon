...
Ryxon 图标库托管在 [iconfont.cn](https://iconfont.cn) 上，同时仓库中保留了一份完整的 Sketch 设计稿。
...
<img src="https://fastly.jsdelivr.net/npm/@ryxon/assets/iconfont-upload.png" style="width: 800px;">

> 此步骤需要图标库管理员权限，请联系 Ryxon 维护者进行添加。
...
<img src="https://fastly.jsdelivr.net/npm/@ryxon/assets/icon-transform.png" style="width: 800px;">

### 4. 发布图标库

执行 `yarn release` 命令，发布 `@ryxon/icons` 到 npm。
